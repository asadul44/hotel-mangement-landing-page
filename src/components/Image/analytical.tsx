...
// Define the type for the `animate` object
type AnimateType = {
  scale: {
    scale: number;
    opacity: number;
...
// Add the SvgDrawPlugin to TweenOne's plugins
  ...
  return (
    <svg viewBox="0 0 790 542" width="100%" height="100%">
      ...
      <g
        ...
        fillRule="evenodd"
      >
        <g id="analythical" transform="translate(-68.000000, -88.000000)">
